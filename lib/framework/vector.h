...
inline Vector3i toVector(Rotation const &r)
{
...
inline int operator *(Vector2i const &a, Vector2i const &b) [[pure]]
{
	return a.x * b.x + a.y * b.y;
}
inline int operator *(Vector3i const &a, Vector3i const &b) [[pure]]
{
...
template<typename T>
 T normalise(const T&a) [[pure]]
{
	return a.length() > 0.f ? glm::normalize(a) : a;
}
 ...
 * \return Result
 */
static inline Vector2f Vector2f_Rotate2f(Vector2f v, int angle) [[pure]]
{
	Vector2f result;
