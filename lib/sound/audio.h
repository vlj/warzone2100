...
bool audio_PlayStaticTrack(int32_t iX, int32_t iY, int iTrack);
...
void audio_QueueTrackGroup(int32_t iTrack, int32_t iGroup);
void audio_QueueTrackPos(int32_t iTrack, int32_t iX, int32_t iY, int32_t iZ);
void audio_QueueTrackGroupPos(int32_t iTrack, int32_t iGroup, int32_t iX, int32_t iY, int32_t iZ);
