...
static void barGraphDisplay(WIDGET *psWidget, uint32_t xOffset, uint32_t yOffset)
{
...
static void barGraphDisplayDouble(WIDGET *psWidget, uint32_t xOffset, uint32_t yOffset)
{
