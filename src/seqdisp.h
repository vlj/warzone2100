...
//text
extern bool seq_AddTextForVideo(const char *pText, int32_t xOffset, int32_t yOffset, double startTime, double endTime, SEQ_TEXT_POSITIONING textJustification);
